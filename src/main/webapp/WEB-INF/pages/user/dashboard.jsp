            ...
            <div class="user-menu">
                ...
                <div class="user-profile">
                    ...
                    <div class="user-info">
                        ...
                        <div class="user-role"><%= userdas.isAdmin() == 1 ? "Administrator" : "User" %></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="stats-grid">
                <div class="stat-card active-cases">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-change increase"><i class="fas fa-arrow-up"></i> 12% from last month</div>
                    </div>
                </div>
                ...
                <div class="stat-card pending-hearings">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-change increase"><i class="fas fa-arrow-up"></i> 5% from last month</div>
                    </div>
                </div>
                ...
                <div class="stat-card completed-cases">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-change increase"><i class="fas fa-arrow-up"></i> 8% from last month</div>
                    </div>
                </div>
                ...
                <div class="stat-card urgent-matters">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-change decrease"><i class="fas fa-arrow-down"></i> 3% from last month</div>
                    </div>
                </div>
            </div>
