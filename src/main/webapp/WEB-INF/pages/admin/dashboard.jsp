                ...
                <div class="table-responsive">
                    <table class="cases-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="case-title">Online Harrassment</div>
                                    <div class="case-client">Client: Pratyush Sharma</div>
                                </td>
                                <td>
                                    <div class="lawyer-name">
                                        <div class="lawyer-avatar">RS</div>
                                        <span>Rakshya Sapkota</span>
                                    </div>
                                </td>
                                <td><span class="badge badge-primary">Cyber Case</span></td>
                                <td>Supreme Court, Kathmandu</td>
